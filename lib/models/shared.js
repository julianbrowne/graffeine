    ...
    **/
    ...
    buildGraffNode: function(neoNode) { 
        ...
        if(neoType === 'n' || neoType === 'm') { 
            ...
            graffNode.node  = 'n';
            graffNode.name  = shared.setGraffNodeNameFromData(neoNode.data);
            graffNode.type  = shared.setGraffNodeTypeFromData(neoNode.data);
            graffNode.style = shared.setGraffNodeStyleFromData(neoNode.data);
    ...
    mapCypherQueryResult: function(results, columnsWanted) {
        ...
        return items.map(shared.buildGraffNode);
    ...
    errorHandler: function(callback) {
        ...
        return function(error, result) {
            ...
            if (error) {
                ...
                result.node = 'n';
                var graffNode = shared.buildGraffNode(result);
                callback(graffNode);
            }
        }
    }
